...
export interface PrivateIdentityRegistryExampleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "addDid"
...
export interface PrivateIdentityRegistryExample extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateIdentityRegistryExample;
  waitForDeployment(): Promise<this>;

  interface: PrivateIdentityRegistryExampleInterface;
