...
export interface PrivateERC721ExampleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "a"
      | "approve"
...
export interface PrivateERC721Example extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateERC721Example;
  waitForDeployment(): Promise<this>;

  interface: PrivateERC721ExampleInterface;
