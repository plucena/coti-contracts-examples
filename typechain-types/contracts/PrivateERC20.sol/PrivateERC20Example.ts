...
export interface PrivateERC20ExampleInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PrivateERC20Example extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateERC20Example;
  waitForDeployment(): Promise<this>;

  interface: PrivateERC20ExampleInterface;
