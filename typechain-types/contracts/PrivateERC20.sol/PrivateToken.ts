...
export interface PrivateTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PrivateToken extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateToken;
  waitForDeployment(): Promise<this>;

  interface: PrivateTokenInterface;
