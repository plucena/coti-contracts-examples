...
export interface PrivateNFTExampleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "a"
      | "approve"
...
export interface PrivateNFTExample extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateNFTExample;
  waitForDeployment(): Promise<this>;

  interface: PrivateNFTExampleInterface;
