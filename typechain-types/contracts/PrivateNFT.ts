...
export interface PrivateNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface PrivateNFT extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateNFT;
  waitForDeployment(): Promise<this>;

  interface: PrivateNFTInterface;
