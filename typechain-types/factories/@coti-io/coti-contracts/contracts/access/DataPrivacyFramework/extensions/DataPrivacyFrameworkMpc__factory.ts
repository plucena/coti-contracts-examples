...
import type {
  ...
  DataPrivacyFrameworkMpcInterface,
} from "../../../../../../../@coti-io/coti-contracts/contracts/access/DataPrivacyFramework/extensions/DataPrivacyFrameworkMpc";
...
export class DataPrivacyFrameworkMpc__factory {
  static readonly abi = _abi;
  static createInterface(): DataPrivacyFrameworkMpcInterface {
    return new Interface(_abi) as DataPrivacyFrameworkMpcInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as DataPrivacyFrameworkMpc;
  }
}
