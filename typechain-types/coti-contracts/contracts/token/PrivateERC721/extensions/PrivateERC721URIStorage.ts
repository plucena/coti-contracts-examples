...
export interface PrivateERC721URIStorage extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateERC721URIStorage;
  waitForDeployment(): Promise<this>;

  interface: PrivateERC721URIStorageInterface;
