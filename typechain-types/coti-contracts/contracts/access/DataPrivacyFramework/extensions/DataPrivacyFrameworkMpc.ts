...
export interface DataPrivacyFrameworkMpcInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADDRESS_ALL"
      | "STRING_ALL"
...
export interface DataPrivacyFrameworkMpc extends BaseContract {
  connect(runner?: ContractRunner | null): DataPrivacyFrameworkMpc;
  waitForDeployment(): Promise<this>;

  interface: DataPrivacyFrameworkMpcInterface;
